...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS website.keg_package_inventory (
    ...
    case_12oz_four_pack_price numeric(8,2) NOT NULL DEFAULT 0,
    case_12oz_six_pack_price numeric(8,2) NOT NULL DEFAULT 0,
    cases_16oz integer NOT NULL DEFAULT 0,
    case_16oz_price numeric(8,2) NOT NULL DEFAULT 0,
    case_16oz_four_pack_price numeric(8,2) NOT NULL DEFAULT 0,
    case_size text,
  ...
  `ALTER TABLE IF EXISTS website.shop_products ADD COLUMN IF NOT EXISTS product_type text NOT NULL DEFAULT 'merchandise'`,
  `ALTER TABLE IF EXISTS website.shop_products ADD COLUMN IF NOT EXISTS ticket_location_slug text`,
  `ALTER TABLE IF EXISTS website.shop_products ADD COLUMN IF NOT EXISTS ticket_event_starts_at timestamptz`,
  ...
  `ALTER TABLE IF EXISTS website.shop_orders ADD COLUMN IF NOT EXISTS checkout_expires_at timestamptz`,
  `ALTER TABLE IF EXISTS website.shop_order_items ADD COLUMN IF NOT EXISTS is_bonus boolean NOT NULL DEFAULT false`,
  `CREATE TABLE IF NOT EXISTS website.shop_ticket_purchases (
    id bigserial PRIMARY KEY,
    order_id bigint NOT NULL REFERENCES website.shop_orders(id) ON DELETE CASCADE,
    order_item_id bigint NOT NULL UNIQUE REFERENCES website.shop_order_items(id) ON DELETE CASCADE,
    product_id bigint REFERENCES website.shop_products(id) ON DELETE SET NULL,
    variant_id bigint REFERENCES website.shop_product_variants(id) ON DELETE SET NULL,
    product_name text NOT NULL,
    variant_label text NOT NULL,
  ...
  `ALTER TABLE IF EXISTS website.shop_ticket_purchases DROP CONSTRAINT IF EXISTS shop_ticket_purchases_party_size_check`,
  `ALTER TABLE IF EXISTS website.shop_ticket_purchases ADD CONSTRAINT shop_ticket_purchases_party_size_check CHECK (party_size BETWEEN 1 AND 1000)`,
  ...
  `CREATE INDEX IF NOT EXISTS website_shop_ticket_purchases_product_idx ON website.shop_ticket_purchases (product_id, paid_at DESC)`,
  ...
  `ALTER TABLE IF EXISTS website.keg_package_inventory ADD COLUMN IF NOT EXISTS case_12oz_four_pack_price numeric(8,2) NOT NULL DEFAULT 0`,
  `ALTER TABLE IF EXISTS website.keg_package_inventory ADD COLUMN IF NOT EXISTS case_12oz_six_pack_price numeric(8,2) NOT NULL DEFAULT 0`,
  `ALTER TABLE IF EXISTS website.keg_package_inventory ADD COLUMN IF NOT EXISTS case_16oz_four_pack_price numeric(8,2) NOT NULL DEFAULT 0`,
