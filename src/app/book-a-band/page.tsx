...
export default function BookABandPage() {
  const applyUrl = process.env.AVIATOR_LIVE_APPLY_URL || (process.env.NODE_ENV === "development" ? "http://localhost:5123/apply" : "http://aviatorlive.is-with-theband.com/apply");
  return <main>
