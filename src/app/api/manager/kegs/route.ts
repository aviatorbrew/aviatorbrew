  ...
  try {
    ...
    const inventory = body.action === "edit"
      ? await updateKegItem({
          ...
          case12FourPackPriceCents: body.case12FourPackPriceCents,
          case12SixPackPriceCents: body.case12SixPackPriceCents,
          case16PriceCents: body.case16PriceCents,
          case16FourPackPriceCents: body.case16FourPackPriceCents,
