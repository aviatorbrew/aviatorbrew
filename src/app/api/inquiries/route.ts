...
export async function POST(request: Request) {
  try {
    ...
    if (isMailConfigured()) {
      ...
      const recipient = body.kind === "event" ? process.env.PRIVATE_EVENT_INQUIRY_RECIPIENT_EMAIL || "events@aviatorbrew.com" : process.env.FORM_RECIPIENT_EMAIL || process.env.MAIL_FROM_EMAIL!;
