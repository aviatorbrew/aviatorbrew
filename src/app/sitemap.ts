...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = ["", "/beer", "/locations", "/itinerary", "/events", "/events/live-music", "/private-events", "/catering-to-go", "/brewery", "/distillery", "/about", "/careers", "/contact", "/shop", "/shop-new", "/faq", "/more", "/become-a-pilot", "/order-food", "/kegs", "/gift-card-balance", "/book-a-band", "/donation-requests", "/apply-for-a-job"];
