...
export default function sitemap(): MetadataRoute.Sitemap {
  const base = process.env.NEXT_PUBLIC_SITE_URL || "https://aviatorbrew.com";
  const pages = ["", "/beer", "/locations", "/itinerary", "/events", "/events/live-music", "/private-events", "/brewery", "/distillery", "/about", "/careers", "/contact", "/shop", "/faq", "/more", "/order-food", "/kegs", "/gift-card-balance", "/book-a-band", "/donation-requests", "/apply-for-a-job"];
