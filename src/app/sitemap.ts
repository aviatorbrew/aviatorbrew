...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages = ["", "/beer", "/locations", "/itinerary", "/events", "/events/live-music", "/private-events", "/brewery", "/distillery", "/about", "/careers", "/contact", "/shop", "/shop-new", "/faq", "/more", "/order-food", "/kegs", "/gift-card-balance", "/book-a-band", "/donation-requests", "/apply-for-a-job"];
