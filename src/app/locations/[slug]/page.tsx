...
import { getLocationHero, getLocationPhotos, type LocationPhoto } from "@/lib/location-photos";
import { getLiveMusicSchedule, getLocationLiveShows, liveMusicPageUrl } from "@/lib/live-music";

export const dynamic = "force-dynamic";
function LocationGalleryMedia({ photo, alt }: { photo: LocationPhoto; alt: string }) {
  return photo.mediaType === "video"
    ? <video src={photo.url} controls muted playsInline preload="metadata" />
    : <Image src={photo.url} alt={alt} fill unoptimized sizes="(max-width: 700px) 100vw, 33vw" />;
}
