...
export default async function BeerPage() {
  ...
  return <>
    ...
    <section className="section beer-lineup-section"><div className="content-wrap">
      {newestBeers.length ? <div className="new-squadron" aria-labelledby="new-squadron-title"><div className="section-heading new-squadron-heading"><div><p className="eyebrow">Fresh arrivals</p><h2 id="new-squadron-title">New to the <em>Squadron</em></h2></div><p>Our latest beer additions.</p></div><div className="new-squadron-grid">{newestBeers.map((beer) => <BeerCard key={beer.slug} beer={beer} />)}</div></div> : null}
