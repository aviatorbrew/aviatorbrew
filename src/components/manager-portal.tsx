...
function TourManager() {
  ...
  function applyData(data: { signups: Signup[]; scheduledTours?: ScheduledTour[]; minimum?: number; priceCents?: number }) { setSignups(data.signups); setScheduledTours(data.scheduledTours || []); setMinimum(data.minimum ?? DEFAULT_TOUR_MINIMUM); setTourPrice((data.priceCents ?? DEFAULT_TOUR_PRICE_CENTS) / 100); setTourSettingsLoaded(true); }
