export type Location = {
  ...
  image: string; accessibility: string; parking: string; history: string;
};
...
export const primaryNav = [
  ...
  { label: "MORE", href: "/more", children: [{ label: "Become a Pilot", href: "/become-a-pilot" }, { label: "About", href: "/about" }, { label: "Tours", href: "/about#brewery-tours" }, { label: "Contact Us", href: "/contact" }] },
];

export const locations: Location[] = [
  { slug: "hangar-bar", name: "Aviator Hangar Bar", shortName: "Hangar Bar", type: "Flagship brewery campus", description: "Fresh Aviator beer, scratch-made food, live music, and a front-row seat to the energy of the brewery campus.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Sun–Tue 11am–10pm · Wed–Thu 11am–12am · Fri–Sat 11am–1am", menu: "/locations#menus", events: true, image: "/images/locations/hangar-bar.png", accessibility: "Step-free entry and accessible restrooms.", parking: "On-site parking with accessible spaces.", history: "The Hangar Bar is part of Aviator's new brewery campus at 688 Brewing Drive, opened in April 2025 as the next chapter after the original hangar brewery and downtown Varina restaurants. It was built to put guests close to the production brewery, live music, food, and the aviation-inspired gathering spaces that define the campus." },
  { slug: "aviator-amphitheater", name: "Aviator Amphitheater", shortName: "Aviator Amphitheater", type: "Outdoor concert venue", description: "Big-stage energy for concerts, festivals, and brewery campus nights under the open sky.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Event schedule varies", events: true, image: "/images/website-photos/90-brewery-campus.jpg", accessibility: "Accessible event routes and seating are available.", parking: "On-site brewery campus parking is available.", history: "The Aviator Amphitheater grew out of the 688 Brewing Drive campus plan: a destination where beer, food, outdoor gathering space, and live entertainment operate together. It gives Aviator a dedicated outdoor stage for concerts, festivals, release parties, and campus-scale community events." },
  { slug: "taphouse", name: "Aviator TapHouse", shortName: "TapHouse", type: "The original Aviator", description: "Brewery-fresh beer and gastropub favorites in the historic Varina train depot.", address: "600 E. Broad St., Fuquay-Varina, NC 27526", phone: "919-552-8826", hours: "Mon–Thu 11:30am–11pm · Fri–Sat 11:30am–1am · Sun 11:30am–10pm", menu: "/locations#menus", image: "/images/locations/taphouse.png", accessibility: "Accessible entry and seating available.", parking: "Street and nearby public parking.", history: "Aviator TapHouse opened in September 2009 inside the old Varina train depot. Aviator's early TapHouse history traces the depot story to 1903 and notes that the building once sat beside the tracks just behind its current location. The lower-left side served as the town telegraph office. Today the room keeps that railroad character with plank floors, heavy wood, brewery-fresh beer, and a 38-foot African mahogany bar." },
  { slug: "pizza-pub", name: "Aviator Pizza Pub", shortName: "Pizza Pub", type: "Pizza + BeerShop", description: "Brick-oven pizza, Aviator beer, a rooftop vibe, and beer to take home.", address: "601 E. Broad St., Fuquay-Varina, NC 27526", phone: "919-346-8206", hours: "Mon–Thu 11:30am–11pm · Fri–Sat 11:30am–12am · Sun 11:30am–10pm", menu: "/locations#menus", image: "/images/locations/pizza-pub.png", accessibility: "Accessible entry and main-level seating.", parking: "Street and nearby public parking.", history: "Aviator Pizza Pub and BeerShop expanded the downtown Varina Aviator district across from the TapHouse, adding pizza, beer to go, rooftop energy, and another reason to gather along East Broad Street. It carries the same downtown rail-district feel while giving guests a casual food-and-beer stop next to the original Aviator TapHouse." },
  { slug: "harddeck", name: "Aviator HardDeck Restaurant", shortName: "HardDeck", type: "Future steakhouse restaurant", description: "A future campus restaurant planned around hand-cut steaks, warm hospitality, and Aviator’s unmistakable energy.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Coming soon", comingSoon: true, image: "/images/locations/harddeck.png", accessibility: "Accessibility details will be published before opening.", parking: "Campus parking details will be published before opening.", history: "HardDeck is planned as part of the 688 Brewing Drive brewery campus, extending Aviator's aviation theme into a future steakhouse-style restaurant. The space is being developed around the idea of a stronger dinner destination on campus, connected to brewery visits, private events, live music, and the wider Aviator experience." },
  { slug: "c-54-airplane-bar", name: "Aviator C-54 Airplane Bar", shortName: "C-54 Airplane Bar", type: "Future aviation landmark bar", description: "A future one-of-a-kind bar experience planned around an iconic Aviator aircraft.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Coming soon", comingSoon: true, image: "/images/locations/c-54-airplane-bar.png", accessibility: "Accessibility details will be published before opening.", parking: "Campus parking details will be published before opening.", history: "The C-54 Airplane Bar is planned as a future aviation landmark on the brewery campus. It continues Aviator's habit of turning aircraft history into guest experience, creating a bar concept centered on an iconic transport aircraft and the larger campus story of flight, beer, and hospitality." },
  { slug: "ready-room", name: "Ready Room Liquor Lounge", shortName: "Ready Room", type: "Cocktails + private events", description: "A private-event room for up to 70 guests including the bar, with aviation-inspired cocktails, a stage, microphone, full sound, and AV capability.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Event hours vary", events: true, image: "/images/locations/ready-room.png", accessibility: "Accessible entry and event seating.", parking: "Campus parking available.", history: "The Ready Room was created as the campus private-event and cocktail lounge space: a room for celebrations, meetings, music, speeches, and gatherings with a stage, microphone, sound, and AV support. Its name follows the aviation idea of a place where crews gather before the next mission." },
  { slug: "speakeasy", name: "The Whiskey Bar", shortName: "The Whiskey Bar", type: "Whiskey + cocktails", description: "An intimate lounge for considered cocktails, whiskey, and a little after-hours mystery.", address: "688 Brewing Drive, Fuquay-Varina, NC 27526", phone: "919-567-2337", hours: "Hours coming soon", image: "/images/locations/speakeasy.png", accessibility: "Accessibility details coming soon.", parking: "Campus parking available.", history: "The Whiskey Bar is Aviator's intimate liquor lounge concept on the brewery campus. It adds a quieter cocktail and whiskey-focused stop to the Aviator lineup while keeping the same aviation character and campus hospitality that connect the bars, restaurants, brewery, and event spaces." },
];
